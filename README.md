...
└── requirements.txt        # List of dependencies and package versions


Contributors
	•	Nick Tran – Project architecture, code integration, and pipeline development.
	•	George Wilfert – Data preprocessing, model evaluation, and presentation development.

⸻

License

San Jose State Department of BioInformatics
⸻

Contact

	•	Nick Tran: nick.tran@sjsu.com
	•	George Wilfert: george.wilfert@example.com
